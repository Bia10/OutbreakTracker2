...
public partial class ItemSlotView : UserControl, IDisposable
{
    private Border? _glowBorder;
    private CancellationTokenSource? _glowCts;
    private ItemSlotViewModel? _currentViewModel;
    ...
    private void OnDataContextChanged(object? sender, EventArgs e)
    {
        ...
        _currentViewModel = DataContext as ItemSlotViewModel;
