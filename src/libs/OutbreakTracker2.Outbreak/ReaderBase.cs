...
public abstract class ReaderBase
{
    ...
    protected T ReadSlotValue<T>(int slotIndex, nint[] offsetsFile1, nint[] offsetsFile2, string methodName, T errorValue) where T : struct
    {
    ...
    protected static string GetEnumString<TEnum>(object value, TEnum defaultValue) where TEnum : struct, Enum
    {
