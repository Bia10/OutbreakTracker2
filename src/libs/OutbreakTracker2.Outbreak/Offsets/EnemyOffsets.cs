...
internal static class EnemyOffsets
{
    ...
    public static readonly (nint[] File1, nint[] File2) CurHealth = (
        [FileOnePtrs.EnemyHpOffset],
        [FileTwoPtrs.EnemyHpOffset]
    );
    public static readonly (nint[] File1, nint[] File2) MaxHealth = (
        [FileOnePtrs.EnemyMaxHpOffset],
        [FileTwoPtrs.EnemyMaxHpOffset]
    );
    public static readonly (nint[] File1, nint[] File2) Type = (
        [FileOnePtrs.EnemyTypeOffset],
        [FileTwoPtrs.EnemyTypeOffset]
    );
    public static readonly (nint[] File1, nint[] File2) EnemyListBase = (
        [FileOnePtrs.EnemyListOffset],
        [FileTwoPtrs.EnemyListOffset]
    );
    public static readonly (int File1, int File2) EnemyListEntrySize = new(
