...
{
    public static readonly (nint[] File1, nint[] File2) ScenarioId = (
        [FileOnePtrs.InGameScenarioId],
        [FileTwoPtrs.InGameScenarioId]
    );
    public static readonly (nint[] File1, nint[] File2) FrameCounter = (
        [FileOnePtrs.InGameFrameCounter],
        [FileTwoPtrs.InGameFrameCounter]
    );
    public static readonly (nint[] File1, nint[] File2) ScenarioStatus = (
        [FileOnePtrs.ScenarioStatus],
        [FileTwoPtrs.ScenarioStatus]
    );
    public static readonly (nint[] File1, nint[] File2) PlayerNumber = (
        [FileOnePtrs.InGamePlayerNumber],
        [FileTwoPtrs.IngamePlayerNumber]
    );
    public static readonly (nint[] File1, nint[] File2) Difficulty = (
        [FileOnePtrs.Difficulty],
        [FileTwoPtrs.Difficulty]
    );
    public static readonly (nint[] File1, nint[] File2) ItemRandom = (
        [FileOnePtrs.ItemRandom],
        [FileTwoPtrs.ItemRandom]
    );
    public static readonly (nint[] File1, nint[] File2) ItemRandom2 = (
        [FileOnePtrs.ItemRandom2],
        [FileTwoPtrs.ItemRandom2]
    );
    public static readonly (nint[] File1, nint[] File2) PuzzleRandom = (
    ...
    public static readonly (nint[] File1, nint[] File2) DesperateTimesFightTime = (
        [],
        [FileTwoPtrs.DesperateTimesFightTime]
    );
    public static readonly (nint[] File1, nint[] File2) DesperateTimesFightTime2 = (
        [],
        [FileTwoPtrs.DesperateTimesFightTime2]
    );
    public static readonly (nint[] File1, nint[] File2) DesperateTimesGarageTime = (
        [],
        [FileTwoPtrs.DesperateTimesGarageTime]
    );
    public static readonly (nint[] File1, nint[] File2) DesperateTimesGasTime = (
        [],
        [FileTwoPtrs.DesperateTimesGasTime]
    );
    public static readonly (nint[] File1, nint[] File2) DesperateTimesGasFlag = (
        [],
        [FileTwoPtrs.DesperateTimesGasFlag]
    );
    public static readonly (nint[] File1, nint[] File2) DesperateTimesGasRandom = (
        [],
    ...
    public static readonly (nint[] File1, nint[] File2) PickupSpaceStart = (
        [FileOnePtrs.PickupSpaceStart],
        [FileTwoPtrs.PickupSpaceStart]
    );
    public static readonly (int File1, int File2) PickupStructSize = new(
    ...
    public static readonly (nint File1, nint File2) ItemPickupCountOffset = (
        FileOnePtrs.PickupCountOffset,
        FileTwoPtrs.PickupCountOffset
    );
    public static readonly (nint File1, nint File2) ItemPickupOffset = (
        FileOnePtrs.PickupOffset,
        FileTwoPtrs.PickupOffset
    );
}
