...
public static class TimeUtility
{
    ...
    {
        int minutes = (int)
            Math.Floor((double)stoppingVirusTimeUnits / StoppingVirusTimeUnitsPerMinute % MinutesPerHour);
        int seconds = (int)
            Math.Floor((double)stoppingVirusTimeUnits / StoppingVirusTimeUnitsPerSecond % SecondsPerMinute);
