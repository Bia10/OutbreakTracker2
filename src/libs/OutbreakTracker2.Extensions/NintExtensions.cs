...
public static class NintExtensions
{
    ...
    public static bool IsNotNull(this nint nativeInteger) => nativeInteger != nint.Zero;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNotNegative(this nint nativeInteger) => nativeInteger >= nint.Zero;
